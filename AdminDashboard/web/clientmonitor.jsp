    ...
    <body>
            ...
            <div class="navbar">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="active"><a href="clientmonitor.jsp">Monitor Clients</a></li>
        ...
        <div class="container">
                    ...
                    <center><div class="form-group">
                            <h1><b>Monitor Client Activities</b></h1>
                    </div></center>
              <center> 
            <form method="get" action="clientservlet">    
                      <div class="form-group">
                          <h3><b>Select the Client<b></h3></br></br>
       <%
            Connection con;
         ...
         try
{
            ...
            pst = con.prepareStatement("select distinct nic from client");
    rs=pst.executeQuery();
